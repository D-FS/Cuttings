...
def bbox_plot (coord_agg, optim_rotation_angle_x, optim_rotation_angle_y, npoints_bbox):
    """
    ...
    X = x + x + x + x + MIN_X + MAX_X + MIN_X + MAX_X + MIN_X + MAX_X + MIN_X + MAX_X
    Y = MIN_Y + MAX_Y + MIN_Y + MAX_Y + y + y + y + y + MIN_Y + MIN_Y + MAX_Y + MAX_Y
    Z = MIN_Z + MIN_Z + MAX_Z + MAX_Z + MIN_Z + MIN_Z + MAX_Z + MAX_Z + z + z + z + z
